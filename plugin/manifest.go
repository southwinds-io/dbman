...
// Manifest a database manifest containing the metadata required by DbMan
...
// Script a database script and zero or more merge variables
type Script struct {
...
// Var a merge variable for a script
type Var struct {
...
// Version carries version information
type Version struct {
...
// Upgrade the commands to run at different stages in an upgrade
type Upgrade struct {
	Description string `json:"description"`
